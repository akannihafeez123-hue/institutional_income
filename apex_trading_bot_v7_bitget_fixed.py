...
# ═══════════════════════════════════════════════════════════════════════════
# BITGET API CLIENT - UPDATED FOR V3 API WITH CORRECT PARAMETERS
# ═══════════════════════════════════════════════════════════════════════════
            ...
            async with BitgetAPI(
                ...
                if symbols:
                    ...
                    if klines:
                        ...
                        await update.message.reply_text(f"Sample candle: {sample}")
                    else:
    ...
    try:
        ...
        async with BitgetAPI(
            ...
            if klines:
                ...
                if klines:
                    sample = klines[0]
                    logging.info(f"Sample candle data: {sample}")
            else:
