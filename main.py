...
def start_worker_and_bot():
    ...
    # Start bot polling (signal-safe)
    print("[bot] Starting polling (signal handling disabled)...")
    # stop_signals=None prevents the library from registering signal handlers,
    # avoiding set_wakeup_fd errors in restricted environments or when not run in main thread.
